...
#include <map>
#include <math.h>
#include "CplusplusNumberToken.h"
...
int CplusplusNumberToken::MAX_EXPONENT = 37;

CplusplusNumberToken::CplusplusNumberToken(Source *source) throw (string)
 ...
 */
void CplusplusNumberToken::extract() throw (string)
{
 ...
 * @throws Exception if an error occurred.
 */
string CplusplusNumberToken::unsigned_integer_digits() throw (string)
{
 ...
 */
int CplusplusNumberToken::compute_integer_value(string digits)
{
 ...
 */
float CplusplusNumberToken::compute_float_value(string whole_digits,
